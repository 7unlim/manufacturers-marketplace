...
import { CheckCircle2, ArrowRight, ArrowLeft, Building2, Factory, Wrench, Sparkles, Home, Briefcase, Hammer, Zap, Shield, FileText, Input } from "lucide-react";
...
const SellerOnboarding = ({ onComplete, onSkip, initialData }: OnboardingProps) => {
